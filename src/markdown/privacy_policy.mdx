Please read this Privacy Policy (“**Privacy Policy**”) carefully. It provides information about how RaidenX Corp. (“RaidenX Corp”, “**we**”, “**us**”, and “**our**”) collects, uses, shares, and otherwise processes personal information. If you have any questions, comments, or concerns please [contact us](/privacy-policy#contact-us) using the methods provided in the “Contact Us” section of this Privacy Policy below.
...
This Privacy Policy applies to personal information that RaidenX Corp collects, uses, shares, and otherwise processes when you:

- Access or use our website available at any website operated or made available by RaidenX Corp where this Privacy Policy is posted(collectively, the “**Website**”);
- Access or use any of the RaidenX Corp services or functionality we make available through the Website (collectively, the “**Products**”);
...
- Visitors to the Website and any individuals who communicate with or receive communications from RaidenX Corp; and
...
4. **_Attending Events_**. If you sign up for or attend a webinar or other event hosted by RaidenX Corp, we collect registration and attendance information. If you attend a conference, trade show, or other event that RaidenX Corp attends or sponsors, we may collect information about individuals who attend the event and/or information from individuals who interact with us or express an interest in our Services. This information may include your name and email address as well as any professional background information you may choose to share.
...
1. **_RaidenX Corp’s Service Providers_**: We receive information from our service providers or agents who perform business services for RaidenX Corp, such as Website activity information from third parties that assist us in operating our Website and transactional data from our third-party infrastructure service providers, as applicable.
2. **_RaidenX Corp’s Partners_**: We may receive contact information from business partners with whom we operate co-branded events, webinars, services and marketing campaigns or joint offerings.
3. **_Analytics and Marketing Providers_**: We may receive information from third parties that perform data analytics and/or marketing functions for RaidenX Corp.
...
RaidenX Corp does not intentionally collect sensitive personal information (e.g., social security numbers, racial or ethnic information, health information, religious information).
...
Non-public information about our users will not be released to law enforcement except in response to an appropriate legal process such as a subpoena, court order, or other valid legal process that has been reviewed by RaidenX Corp. However, if we receive information that provides us with a good faith belief that there is an exigent emergency, we may provide information to law enforcement trying to prevent or mitigate the danger, to be determined on a case-by-case basis.
...
To stop receiving, or opt-out of, promotional email communications from RaidenX Corp, click on the "unsubscribe" link or follow the relevant opt-out instructions within the marketing communication. If you opt-out, we will still send you transactional emails for service purposes, such as for responses to your requests or communications about your account.

##### (b) Third Party Analytics

RaidenX Corp uses third-party analytics providers to provide us with information regarding the use of the Services. For more information about the tracking technologies that these third parties use and your options, please see the [Cookies and Tracking Technologies](/privacy-policy#cookies) section above.
...
2. **_Legitimate Interest_**. We process personal data when RaidenX Corp has a legitimate interest to do so. This includes, for example, processing personal data to:
...
3. **_Legal Obligation_**. We process personal information for compliance with any legal obligation to which RaidenX Corp is subject.
4. **_Consent_**. We process personal information based on consent where we obtain your consent prior to such processing. This processing may include, for example:
   ...
   Where RaidenX Corp relies on your consent as the lawful basis for processing personal data, you have the right to withdraw your consent to further use of your personal data at any time. You can use the methods described in Exercising Your Rights below to withdraw your consent.
