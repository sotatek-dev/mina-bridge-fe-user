...
- **Step 3**: Choose "From" Network - This is the source network, ensure the correct network is selected , Ethereum in this case. If you select Ethereum, connect with Metamask, if you select Mina, connect with Auro.

- **Step 4**: Click the "Connect Metamask" button to start the wallet connection process for Ethereum. If you chose Mina, ensure Auro is connected.
